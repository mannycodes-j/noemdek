  ...
  return (
    <>
      <header className="flex items-center ml-20 md:ml-0 justify-between p-4 sm:p-6 border-b border-[#404040] bg-[#262626]">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <Button
            ...
            className="hidden sm:flex text-white hover:text-white bg-[#525252] rounded-full hover:bg-[#606060] w-10 h-10 transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] hover:scale-110 focus:outline-none cursor-pointer"
          >
          ...
          <Button
            variant="ghost"
            className="text-white hover:text-white bg-[#525252] rounded-[40px] hover:bg-[#606060]  px-4 py-2 sm:px-4 sm:py-2 h-10 transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] hover:scale-105 focus:outline-none cursor-pointer"
          ...
          <Button
            variant="ghost"
            size="icon"
            className="text-white hover:text-white bg-[#525252] rounded-[40px] hover:bg-[#606060]  w-10 h-10 relative transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] hover:scale-110 focus:outline-none cursor-pointer"
          ...
          <div className="relative w-[72px] h-[36px] flex items-center">
            <div
              className="absolute inset-0 flex items-center justify-between bg-teal-600 dark:bg-[#00695C] rounded-full px-4 transition-colors duration-300"
              ...
              className={`
                ...
                ${
                  theme === 'dark'
                    ...
                    : 'right-1 bg-teal-400 text-white'
                }
              `}
      ...
      <NotificationModal
        ...
        onClose={() => handleNotificationModalChange(false)}
      />
      <SearchModal
