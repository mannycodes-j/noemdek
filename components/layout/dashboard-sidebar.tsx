            ...
            {navigationItems.map((item, index) => (
              ...
              <Button
                ...
                className={`w-full justify-start ${
                  isMobileOpen ? 'px-4 gap-2 text-base' : 'px-6 gap-3 text-lg'
                } h-12 ${
                  item.active
                    ? ' text-teal-400 '
        ...
        {!isCollapsed && (
          <div className="p-6  border-gray-800">
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <h1 className="text-[24px] font-light text-teal-400">
                  Petro<span className="text-white font-light">data</span>
                </h1>
              </div>
            </div>
          </div>
